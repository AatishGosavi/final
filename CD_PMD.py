...
def process_csv(file_path):
    ...
    try:
        ...
        parsed_data = {
            ...
            "disp_1285_1330": None, "disp_1270_1340": None, "disp_1575": None,
            "cd_1460": None, "disp_1625": None, "disp_1570": None, "disp_1260": None,
            "pmd_1310": None, "pmd_1550": None, "disp_slope": None,
            "pmd_records": [], "raw_cd_points": []
        }
        ...
        with open(file_path, "r", errors='ignore') as f:
            for line in f:
                ...
                # --- 3. CHROMATIC DISPERSION METRICS PROCESSING ---
                elif state == "CD":
                ...
                # --- 4. KEY WAVELENGTH MATRIX SCANNING ---
