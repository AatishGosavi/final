...
MACHINE_NUMBER = config.get('Machine', 'Machine', fallback='UNKNOWN')
...
def send_to_postgres(data):
    query = """
        INSERT INTO pt_machine_logs (
            ...
            idle_time, runtime, machine_number
        ) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)
        ON CONFLICT (spool_code_tu, machine_number) DO UPDATE SET
    ...
    values = (
        ...
        data.get("IdleTime"), data.get("Runtime"), MACHINE_NUMBER
    )
