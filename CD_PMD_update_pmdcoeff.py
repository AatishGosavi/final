            ...
            for line in f:
                ...
                # --- 2. INTERFEROMETRIC PMD PROCESSING ---
                    ...
                    if key_lower.startswith("pmd (ps)"):
                        ...
                        if w1 == 1310:
                            parsed_data["pmd_1310"] = p_vals.get("coeff_w1")
                        elif w1 == 1550:
                            parsed_data["pmd_1550"] = p_vals.get("coeff_w1")
                        ...
                        if w2:
                            if w2 == 1310:
                                parsed_data["pmd_1310"] = p_vals.get("coeff_w2")
                            elif w2 == 1550:
                                parsed_data["pmd_1550"] = p_vals.get("coeff_w2")
